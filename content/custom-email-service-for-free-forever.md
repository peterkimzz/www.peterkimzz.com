...
category: tech
created: 2021-09-30
description: 안녕하세요. 또 다시 찾아온 평생 무료 시리즈입니다. 저는 틈만나면 1인 사이드 프로젝트를 진행하기 때문에, 어떻게든 공짜로 서버를 돌리기 위해 온갖 노력을 하고 있습니다. 그래서 무료로 이용하는 방법에 관한 글을 몇 개 올렸는데 GA를 살펴보니 다른 주제보다 조회수가 높더군요. 역시 공짜가 좋네요.
  ...
  value:
    - - p
      ...
      - - strong
        - {}
        - 평생 무료
      - " 시리즈입니다. 저는 틈만나면 1인 사이드 프로젝트를 진행하기 때문에, 어떻게든 공짜로 서버를 돌리기 위해 온갖 노력을 하고 있습니다. 그래서 무료로 이용하는 방법에 관한 글을 몇 개 올렸는데 GA를 살펴보니 다른 주제보다 조회수가 높더군요. 역시 공짜가 좋네요."
---
...
![image](https://user-images.githubusercontent.com/20244536/135370985-2cee0aff-da43-4008-86e3-fcd34826d953.png)*카카오 메일 BETA. 스마트워크 유지해주세요. 제발*
...
![image](https://user-images.githubusercontent.com/20244536/135373246-cc81e429-90bc-4f11-b6f4-dbfaafa2c7b4.png)*다음에서 정상적으로 도메인&#x20;*`MX` *레코드를 확인한 상태*
...
저는 `Node.js`를 사용했고, 메일 발송을 위해 `Nodemailer` 라이브러리를 사용했습니다.
